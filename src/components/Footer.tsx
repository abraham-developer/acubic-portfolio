        ...
        <div className="footer-content">
          ...
          <div className="footer-brand">
            <div className="footer-logo">
              <svg viewBox="0 0 40 40" className="footer-cube-svg">
                <g className="footer-cube-lines">
            ...
            <div className="footer-text">
              <span className="footer-name">Cubeark</span>
              <span className="footer-tagline">by Abraham Rivera</span>
            </div>
          </div>
